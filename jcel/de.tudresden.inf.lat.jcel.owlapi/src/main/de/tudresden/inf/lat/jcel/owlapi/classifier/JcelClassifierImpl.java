...
public class JcelClassifierImpl implements JcelClassifier {
	...
	private static final Integer checkpoint04garbageCollection = 20;
	private static final Integer checkpoint05iterations = 70;
	...
	public void finishMonitor() {
		...
		if (this.configuration != null) {
			this.configuration
					.getProgressMonitor()
					.reasonerTaskProgressChanged(this.progress, checkpoint08end);
