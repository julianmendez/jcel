 ...
 * <p>
 * <ul>
 * <li>CR3 : <b>if</b> A &#8849; &exist; r <i>.</i> B &isin; <i>T</i> , <u>(x,
 * A) &isin; S</u>, y = ( B, &empty; ) <br />
 * <b>then</b> R := R &cup; {(r, x, y)}</li>
 * </ul>
 * </p>
 * 
...
public class CR3Rule implements SObserverRule {
	...
	private List<XEntry> applyRule(ClassifierStatus status, Integer x, Integer y) {
		...
		for (GCI2Axiom axiom : status.getExtendedOntology().getGCI2Axioms(y)) {
