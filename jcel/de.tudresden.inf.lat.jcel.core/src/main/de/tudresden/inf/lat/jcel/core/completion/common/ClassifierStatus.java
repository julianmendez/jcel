...
public interface ClassifierStatus {
	...
	/**
	 * Returns the set of properties used by a certain class.
	 * 
	 * @param className
	 *            the class name
	 * @return the set of properties used by a certain class
	 */
	public Set<Integer> getObjectPropertiesUsedByClass(Integer className);
	 ...
	 */
	public Collection<Integer> getRelationByFirst(Integer property,
			Integer leftClass);
	 ...
	 * @return all the related classes
	 */
	public Collection<Integer> getRelationBySecond(Integer property,
			Integer rightClass);

	/**
	 * Returns all the sub properties of a property.
	 * 
	 * @param property
	 *            property to get the sub properties
	 * @return all the sub properties
	 */
	public Collection<Integer> getSubObjectProperties(Integer property);
	...
	/**
	 * Returns all the super properties of a property.
	 * 
	 * @param property
	 *            property to get the super properties
	 * @return all the super properties
	 */
	public Collection<Integer> getSuperObjectProperties(Integer property);
