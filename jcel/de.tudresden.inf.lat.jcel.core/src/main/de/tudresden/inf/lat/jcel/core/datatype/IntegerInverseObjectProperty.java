...
/**
 * This models an object property.
 * 
 * @author Julian Mendez
 * 
 */
public class IntegerInverseObjectProperty implements
	...
	@Override
	public int compareTo(IntegerInverseObjectProperty o) {
		if (o == null) {
			throw new IllegalArgumentException("Null argument.");
		}
	...
	public boolean equals(Object o) {
		boolean ret = false;
		if (o instanceof IntegerInverseObjectProperty) {
			IntegerInverseObjectProperty other = (IntegerInverseObjectProperty) o;
