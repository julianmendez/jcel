 ...
 * using this XML representation. This is an auxiliary abstract class used by
 * <code>OWLReasonerXMLOutput</code>.
 * 
 * @author Julian Mendez
 * 
 * @param <T>
 * 
 * @see OWLReasonerXMLOutput
 */
abstract class XMLGraph<T> {
