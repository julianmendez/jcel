...
/**
 * An object of this class is a factory to create any integer axiom.
 * 
 * @author Julian Mendez
 */
public class ComplexIntegerAxiomFactory {

	/**
	 * Constructs a new integer axiom factory.
	 */
	public ComplexIntegerAxiomFactory() {
	}
