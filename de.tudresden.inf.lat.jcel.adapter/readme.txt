...
This is a subproject of jcel. It contains an adapter, which is used to
adapt an OWL API 3 reasoner to an OWL API 2 reasoner. The OWL API 2
reasoner could be used in Protege.
