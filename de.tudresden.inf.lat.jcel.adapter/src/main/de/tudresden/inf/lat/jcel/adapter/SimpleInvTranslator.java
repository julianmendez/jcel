...
public class SimpleInvTranslator {
	...
	public Set<org.semanticweb.owl.model.OWLObjectProperty> translateToObjectProperties(
		...
		for (OWLObjectPropertyExpression elem : set) {
			ret.add(translateToObjectProperty(elem));
		}
		return ret;
	}
	...
	public Set<Set<org.semanticweb.owl.model.OWLObjectProperty>> translateToObjectProperties(
		...
		Set<Node<OWLObjectPropertyExpression>> setOfSets = nodeSet.getNodes();
		for (Node<OWLObjectPropertyExpression> node : setOfSets) {
			Set<org.semanticweb.owl.model.OWLObjectProperty> current = new HashSet<org.semanticweb.owl.model.OWLObjectProperty>();
			Set<OWLObjectPropertyExpression> set = node.getEntities();
			for (OWLObjectPropertyExpression elem : set) {
				current.add(translateToObjectProperty(elem));
			}
			ret.add(current);
		}
		return ret;
	...
	private org.semanticweb.owl.model.OWLObjectProperty translateToObjectProperty(
			OWLObjectPropertyExpression objectPropertyExpression) {
		return getOWLDataFactory()
				.getOWLObjectProperty(
						objectPropertyExpression.asOWLObjectProperty().getIRI()
								.toURI());
	}
