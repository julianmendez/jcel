...
public class IntegerNamedIndividualDeclarationAxiom implements IntegerDeclarationAxiom {
	 ...
	 *            annotations
	 */
	IntegerNamedIndividualDeclarationAxiom(int declaredEntity, Set<IntegerAnnotation> annotations) {
	...
	public boolean equals(Object obj) {
		...
		if (!ret && (obj instanceof IntegerNamedIndividualDeclarationAxiom)) {
			IntegerNamedIndividualDeclarationAxiom other = (IntegerNamedIndividualDeclarationAxiom) obj;
