...
public class IntegerDataPropertyDeclarationAxiom implements IntegerDeclarationAxiom {
	 ...
	 *            annotations
	 */
	IntegerDataPropertyDeclarationAxiom(int declaredEntity, Set<IntegerAnnotation> annotations) {
	...
	public String toString() {
		...
		sbuf.append(ComplexIntegerAxiomConstant.DataPropertyDeclaration);
		sbuf.append(ComplexIntegerAxiomConstant.LEFT_PAR);
