...
public interface IntegerSubsumerGraph {
	 ...
	 * elements do not belong to the vertex set, they are added anyway.
	 * 
	 * @param subId
	 *            the subsumee
	 * @param superId
	...
	/**
	 * Returns the set of subsumers of a given vertex.
	 * 
	 * @param vertex
	 *            to get the set of subsumers
	 * @return the set of subsumers of the given vertex
	 */
