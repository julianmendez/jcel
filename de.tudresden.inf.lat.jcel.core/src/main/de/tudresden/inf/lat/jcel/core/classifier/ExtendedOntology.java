...
public class ExtendedOntology implements NormalizedIntegerAxiomVisitor<Boolean> {
	...
	private Set<ExtensionEntry> emptyExtensionSet = Collections
			.unmodifiableSet(new HashSet<ExtensionEntry>());
	private Set<RI3Axiom> emptySet = Collections
			.unmodifiableSet(new HashSet<RI3Axiom>());
	...
	public Set<ExtensionEntry> getExistentialEntries(Integer propertyId,
			Integer classId) {
		Set<ExtensionEntry> ret = this.emptyExtensionSet;
