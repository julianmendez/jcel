...
import de.tudresden.inf.lat.jcel.core.completion.ext.CR10OptRule;
import de.tudresden.inf.lat.jcel.core.completion.ext.CR3ExtRule;
import de.tudresden.inf.lat.jcel.core.completion.ext.CR7RRule;
import de.tudresden.inf.lat.jcel.core.completion.ext.CR7SRule;
...
import de.tudresden.inf.lat.jcel.core.normalization.SubPropertyNormalizer;
...
public class OntologyPreprocessor {
	...
	/**
	 * Construcs a new ontology preprocessor.
	 * 
	 * @param axiomSet
	 *            set of axioms
	 */
	...
	private void activateExtendedRules() {
		...
		listR.add(new CR8Rule());
		listR.add(new CR9RRule());
		listR.add(new CR10OptRule());
		this.chainR = new RChain(listR);
	}
	...
	private void preProcess(Set<ComplexIntegerAxiom> axiomSet) {
		...
		this.extendedOntology.load(subPropNormalizer.saturate(axiomNormalizer
				.normalize(axiomSet)));
