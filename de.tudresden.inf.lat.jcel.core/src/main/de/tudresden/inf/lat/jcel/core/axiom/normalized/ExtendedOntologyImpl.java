...
public class ExtendedOntologyImpl implements ExtendedOntology,
	...
	private Map<Integer, Set<GCI3Axiom>> mapOfGCI3A = null;
	private Map<Integer, Map<Integer, Set<GCI3Axiom>>> mapOfGCI3AB = null;
	private Map<Integer, Set<GCI3Axiom>> mapOfGCI3r = null;
	private Map<Integer, Map<Integer, Set<GCI3Axiom>>> mapOfGCI3rA = null;
	private Map<Integer, Map<Integer, Set<GCI3Axiom>>> mapOfGCI3rB = null;
	private Map<Integer, Set<NominalAxiom>> mapOfNominalAxiom = null;
	private Map<Integer, Set<RangeAxiom>> mapOfRangeAxiom = null;
	private Map<Integer, Set<RI2Axiom>> mapOfRI2r = null;
	private Map<Integer, Set<RI2Axiom>> mapOfRI2s = null;
	...
	@Override
	public void clear() {
		this.normalizedAxiomSet = new HashSet<NormalizedIntegerAxiom>();
		...
		this.mapOfGCI3A = new HashMap<Integer, Set<GCI3Axiom>>();
		this.mapOfGCI3r = new HashMap<Integer, Set<GCI3Axiom>>();
		this.mapOfGCI3rA = new HashMap<Integer, Map<Integer, Set<GCI3Axiom>>>();
		this.mapOfGCI3rB = new HashMap<Integer, Map<Integer, Set<GCI3Axiom>>>();
		this.mapOfGCI3AB = new HashMap<Integer, Map<Integer, Set<GCI3Axiom>>>();
		this.mapOfRI2r = new HashMap<Integer, Set<RI2Axiom>>();
		this.mapOfRI2s = new HashMap<Integer, Set<RI2Axiom>>();
	...
	@Override
	public Set<GCI3Axiom> getGCI3rBAxioms(Integer propertyId,
			Integer rightClassId) {
		if (propertyId == null) {
			throw new IllegalArgumentException("Null argument.");
		}
		...
		Set<GCI3Axiom> ret = Collections.emptySet();
		Map<Integer, Set<GCI3Axiom>> map = this.mapOfGCI3rB.get(propertyId);
		if (map != null) {
			ret = map.get(rightClassId);
			if (ret == null) {
				ret = Collections.emptySet();
	...
	public Boolean visit(GCI3Axiom axiom) {
		...
		addGCI3Axiom(this.mapOfGCI3rB, axiom, axiom.getPropertyInSubClass(),
				axiom.getSuperClass());
		addGCI3Axiom(this.mapOfGCI3AB, axiom, axiom.getClassInSubClass(),
				axiom.getSuperClass());
