...
public class ModuleProcessor implements Processor {
	 ...
	 */
	private List<Set<IntegerAxiom>> findModules(Set<IntegerAxiom> axiomSet) {
	...
	private void preProcess(Set<IntegerAxiom> axioms) {
		this.isReady = false;
		...
		this.processor = new CelProcessor(this.moduleList
