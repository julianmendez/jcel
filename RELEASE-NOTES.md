...
|:--------|:-------------|:----:|:--------------|:--------------|
| v0.23.0 | *unreleased* | 7    | 4.1.3         | 5.0.0-beta-17 |
...
* uses the OWL API 4.1.3, and produces a plug-in for Protégé 5.0.0 .
* build commands:
```
$ mvn clean install
```
...
* uses the OWL API 3.5.1, and produces a plug-in for Protégé 5.0.0-beta-17 .
* build commands:
```
$ mvn clean install
```
