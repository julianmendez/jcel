...
import de.tudresden.inf.lat.jcel.core.classifier.DefaultProcessor;
...
public class JcelClassifierImpl implements JcelClassifier {
	...
	protected Processor createProcessor(Set<IntegerAxiom> axiomSet) {
		return new DefaultProcessor(axiomSet);
	}
	...
	public void resetAndLoad(Set<OWLAxiom> owlAxiomSet) {
		...
		this.owlClassAndIndividualGraph = translateToOWLClassOrIndividual(
				this.processor.getClassHierarchy(), translationRep);
